...
{
    /// <summary>
    /// <para>Resumo: Implementação de Métodos e Construtores para a classe Postagem</para>
    ...
    public class PostagemRepositorio : IPostagem
    {
        ...
        public async Task<List<PostagemModelo>> PegarPostagensPorPesquisaAsync(string tituloPostagem, string descricaoTema, string emailCriador)
        {
